...
%-----------------------------------------------------------------------------
  ...
  \centering
  \hspace{-1.25cm}
  \includegraphics[width=0.3965\linewidth]{fig/b310c.png}\hspace{-1.15cm}
  \includegraphics[width=0.3965\linewidth]{fig/b310w.png}\hspace{-1.15cm}
  \includegraphics[width=0.3965\linewidth]{fig/b310h.png}
  \hspace{-1.25cm}
...
Observables, such as entropy or pulsar RM measures \citep{SSFS02} are 
...
For example, wavelet transform methods are used by \citet{st02}, to derive the
...
%\hspace*{0cm} \includegraphics[scale=0.35]{fig/snapshot1new.png}
...
\begin{figure*}
\subfigure[]{\includegraphics[width=0.49\linewidth]{fig/snapshot1.png}}
